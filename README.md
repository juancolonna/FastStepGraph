...
Despite these enhancements, the primary bottleneck of Fast Step Graph lies in the requirement of substantial memory resources $\Big(\frac{p(p-1)}{2}\Big)$ for storing the entire graph, particularly when $p$ grows.
