...
#' @param alpha_f_min Minimum alpha_f threshold value for the cross-validation procedure.
#' @param alpha_f_max Maximum alpha_f threshold value for the cross-validation procedure.
#' @param n_alpha Number of elements in the grid for the cross-validation.
#' @param alpha_b_min Minimum alpha_b threshold value for the cross-validation procedure.
#' @param alpha_b_max Maximum alpha_b threshold value for the cross-validation procedure.
